    ...
    <div className={`min-h-screen motif-${data.motif}`}>
      <div className="mx-auto max-w-6xl px-4 sm:px-5 py-8 sm:py-12">
        <div className="animate-fade-in-up">
          ...
          <h1 className="display text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight">{data.theme}</h1>
          <p className="mt-2 sm:mt-3 text-sm sm:text-base text-[#6d6178] leading-relaxed">{data.location} · {data.tribeCount} tribes</p>
        ...
        <p className="mt-3 sm:mt-4 max-w-2xl animate-fade-in-up delay-2 text-sm sm:text-base text-[#6d6178] leading-relaxed">{data.description}</p>
